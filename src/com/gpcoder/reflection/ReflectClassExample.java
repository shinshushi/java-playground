...
public class ReflectClassExample {
    ...
    public static void getClassInfo() throws ClassNotFoundException, NoSuchMethodException {
        ...
        //Lay mot constructor cu the
        Class catClass = Cat.class;
        Constructor cons = catClass.getConstructor(new Class[]{String.class, int.class});
        System.out.println(cons.getName() + " has " + cons.getParameterCount() + " param");
